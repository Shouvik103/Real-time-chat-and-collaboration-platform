...
export default function RegisterPage() {
  ...
  // Strictly prevent any scrolling on the register page
  useEffect(() => {
      ...
      <SunsetBackground>
        ...
        <div className="pointer-events-auto absolute left-1/2 md:left-[58.9%] top-[18%] md:top-[18%] -translate-x-1/2 z-20 w-[90%] md:w-[27.2%] min-w-[320px] max-w-[420px]">
          <section
            ref={cardRef}
            id="register-card"
            className="relative w-full rounded-[28px] border border-white/10 border-t-white/20 bg-[#10172d]/85 p-6 sm:p-7 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.85),inset_0_1px_0_rgba(255,255,255,0.12)] backdrop-blur-2xl transition-all duration-300 hover:border-white/20"
          >
